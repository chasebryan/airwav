...
| 5. Recording/replay | Bounded pre/post IQ, AWR v1, hashes, SQLite, crash-safe journals, recovery to new bundle, semantic replay controls, SVG export | Automatic event policy, event-linked screenshots/audio, PNG, rotation/cleanup UI, robust event-browser indexing |
...
| 8. More aviation | None claimed | UAT, aviation AM audio, ACARS and VDL2 added independently after validated fixtures and legal module controls |
