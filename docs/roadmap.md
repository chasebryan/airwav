...
| 3. Native terminal | Spectrum, real measurement waterfall, evidence, diagnostics, mouse selection/buttons, zoom/pan, resize, five themes, keyboard help, AM/FM/NFM listening controls | Full settings/control parity, context menus, drag selection, lock/retune/settings controls, recording elapsed time, in-app log panel |
