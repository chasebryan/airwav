...
| 3. Native terminal | Spectrum with dB scale/peak hold/island cursors, measured waterfall, evidence, diagnostics, log, settings, mouse selection/buttons, zoom-to-cursor, click-to-nearest, drag-to-zoom, LIVE vs FADING, five themes, keyboard help, AM/FM/NFM listening, recording elapsed wall time, ring fill, **live VFO retune (n/N, /, cursor, island, Shift-click)** | Context menus, in-app CPU/RSS |
...
| 6. First decoder | Mode S/1090ES PPM + CRC-24; ACARS parity/checksum; APRS AX.25 FCS; POCSAG BCH; SAME header. Synthetic IQ vectors. Frequency coincidence is not identity | Independent known-good recorded RF fixtures, DF/ME expansion, UAT/VDL2 as separate modules |
...
| 8. More aviation | AM/FM/NFM demodulation, terminal live/event listening and verified-IQ WAV export; synthetic validation and system-player delivery | Physical/independent RF audio acceptance, sound-device acceptance and synchronized replay audio; UAT, ACARS and VDL2 added independently after validated fixtures and legal module controls |
