...
| 3. Native terminal | Spectrum, real measurement waterfall, evidence, diagnostics, mouse selection/buttons, zoom/pan, resize, five themes, keyboard help, recording elapsed time in the header | Full settings/control parity, context menus, drag selection, lock/retune/settings controls, in-app log panel |
