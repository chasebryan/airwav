...
| 3. Native terminal | Spectrum with dB scale/peak hold/island cursors, measured waterfall, evidence, diagnostics, log, settings, mouse selection/buttons, zoom-to-cursor, click-to-nearest, drag-to-zoom, LIVE vs FADING, five themes, keyboard help, AM/FM/NFM listening, recording elapsed wall time, ring fill | Context menus, lock/retune/settings that actually retune the V4, in-app CPU/RSS |
